...
public record StatisticSummeryView
{
    ...
    public required IEnumerable<GraphDataModel> OffersGraphData { get; init; }
    public required IEnumerable<GraphDataModel> SalesGraphData { get; init; }
